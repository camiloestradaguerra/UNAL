...
def example2():
    ...
    os.system("python process.py " + "--log_file 'example_log.log' " + "--summary_file 'example_summary.log' " + "--subprocess 'clean' " + "--fecha_inicial '2021-01-01 00:00:00' " + "--fecha_final '2021-01-03 23:59:59' ")

def example3():
    print("Ejemplo para el proceso de entrenamiento")
    os.system("python process.py " + "--log_file 'example_log.log' " + "--summary_file 'example_summary.log' " + "--subprocess 'train' " + "--fecha_inicial '2021-03-01 00:00:00' " + "--fecha_final '2021-03-03 23:59:59' ")
