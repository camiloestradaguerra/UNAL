...
def example4():
    ...
    os.system("python process.py " + "--log_file 'example_log.log' " + "--summary_file 'example_summary.log' " + "--subprocess 'predict' " + "--fecha_inicial '2021-01-01 00:00:00' " + "--fecha_final '2021-03-31 23:59:59' " + "--fecha_inicial_pr '2021-04-01 00:00:00' " + "--fecha_final_pr '2021-04-01 05:59:59' ")
