...
def example3():
    ...
    os.system("python process.py " + "--log_file 'example_log.log' " + "--summary_file 'example_summary.log' " + "--subprocess 'train' " + "--fecha_inicial '2021-03-01 00:00:00' " + "--fecha_final '2021-03-02 23:59:59' ")
