...
def filtering_data(percentage_area, array_cells_events_tst_data_1_cells, two_dim_array_pred_cell, events_gpd_pred, init_date):
    ...
    puntos_gdf_cells_4326 = events_gpd_pred.loc[events_gpd_pred['Celda'].isin(array_cells_hotspots_tst_data_1_number_cell)].to_crs("EPSG:4326")
    ...
    puntos_gdf_cells_4326.to_file("predicted_events.geojson")
